    ...
    return (
        <div className="flex flex-col flex-1 items-center bg-zinc-50 font-sans dark:bg-natural overflow-y-auto max-h-[85vh] md:max-h-full">
            <main className="flex flex-1 w-full flex-col lg:flex-row gap-6 items-start p-4 py-8 bg-white dark:bg-natural max-w-7xl">
                <section className="flex flex-col gap-4 items-start w-full lg:w-xl">
                    <p className="text-sm uppercase tracking-widest text-secondary font-bold">Perfil de usuario</p>
                    <section className="flex flex-col gap-6 items-center w-full lg:bg-white lg:dark:bg-zinc-900 p-6 rounded-xl py-8">
