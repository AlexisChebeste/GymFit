...
const weightHistory : weightGoal = {
  goal: 72,
  history: [
    { date: "2024-06-01", weight: 74 },
    { date: "2024-06-08", weight: 72.5 },
  ]
};
...
export default function Home() {
  ...
  const routine = useLocalStorage("routine", null)[0];
  const templates = useLocalStorage("templates", [])[0];
        ...
        <main className="flex flex-1 w-full flex-col items-start p-4 bg-white dark:bg-natural gap-4 max-w-7xl h-full">
          <section className="flex flex-col gap-4 md:flex-row items-center justify-between w-full mb-4">
            ...
            <div className="flex flex-col">
              ...
              <h1 className="text-4xl font-bold">Hola, Alex!</h1>
              ...
              <Card className="px-6 py-4 flex flex-col gap-2 justify-between w-full">
                ...
                <div className="flex flex-col gap-2 mt-1">
                  <div className="flex items-center justify-between text-xs text-muted-foreground font-medium">
                    <span>Objetivo</span>
                    <span>{current} / {weightHistory.goal}</span>
                  </div>
